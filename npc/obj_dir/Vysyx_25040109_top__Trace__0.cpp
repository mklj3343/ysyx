...
void Vysyx_25040109_top___024root__trace_chg_sub_0(Vysyx_25040109_top___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+32,(((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__lsu__DOT__current_state) 
                               | (IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__is_store))));
        bufp->chgBit(oldp+33,(((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__current_state) 
                               & ((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__current_state) 
                                  & ((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__lsu__DOT__current_state) 
                                     | (IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__is_store))))));
        bufp->chgCData(oldp+34,((0x1fU & (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+35,((0x1fU & (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                          >> 0x14U))),5);
        bufp->chgIData(oldp+36,(((0x37U == (0x7fU & vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg))
                                  ? 0U : vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rdata1_reg)),32);
        bufp->chgIData(oldp+37,(((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__is_add)
                                  ...
                                  : ((0x37U == (0x7fU 
                                      ...
                                      : ((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__is_store)
                                          ...
                                          : (((- (IData)(
                                             ...
                                             | (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                                >> 0x14U)))))),32);
        bufp->chgIData(oldp+38,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__exu__DOT__alu_out),32);
        bufp->chgIData(oldp+39,((0xfffffffeU & vlSelf->ysyx_25040109_top__DOT__cpu__DOT__exu__DOT__alu_out)),32);
        bufp->chgCData(oldp+40,((0x7fU & vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg)),7);
        bufp->chgBit(oldp+41,((IData)((0x13U == (0x707fU 
                                                 & vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg)))));
        bufp->chgIData(oldp+42,((vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                 >> 0xcU)),20);
        bufp->chgSData(oldp+43,(((0xfe0U & (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                            >> 0x14U)) 
                                 | (0x1fU & (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                             >> 7U)))),12);
        bufp->chgIData(oldp+44,((0xfffff000U & vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg)),32);
        bufp->chgIData(oldp+45,((((- (IData)((vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                              >> 0x1fU))) 
                                  << 0xcU) | (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                              >> 0x14U))),32);
        bufp->chgIData(oldp+46,((((- (IData)((vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                              >> 0x1fU))) 
                                  << 0xcU) | ((0xfe0U 
                                               & (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                                  >> 0x14U)) 
                                              | (0x1fU 
                                                 & (vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg 
                                                    >> 7U))))),32);
        bufp->chgIData(oldp+47,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu__DOT__inst_reg),32);
        bufp->chgBit(oldp+48,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__lsu__DOT__current_state));
        bufp->chgBit(oldp+49,(((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__current_state) 
                               & ((IData)(vlSelf->__VdfgTmp_h9113fbb1__0) 
                                  & ((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__idu__DOT____VdfgTmp_h250803ec__0) 
                                     | (IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__is_csrrw))))));
        bufp->chgIData(oldp+50,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[0]),32);
        bufp->chgIData(oldp+51,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[1]),32);
        bufp->chgIData(oldp+52,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[2]),32);
        bufp->chgIData(oldp+53,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[3]),32);
        bufp->chgIData(oldp+54,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[4]),32);
        bufp->chgIData(oldp+55,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[5]),32);
        bufp->chgIData(oldp+56,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[6]),32);
        bufp->chgIData(oldp+57,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[7]),32);
        bufp->chgIData(oldp+58,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[8]),32);
        bufp->chgIData(oldp+59,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[9]),32);
        bufp->chgIData(oldp+60,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[10]),32);
        bufp->chgIData(oldp+61,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[11]),32);
        bufp->chgIData(oldp+62,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[12]),32);
        bufp->chgIData(oldp+63,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[13]),32);
        bufp->chgIData(oldp+64,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[14]),32);
        bufp->chgIData(oldp+65,(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__regfile__DOT__rf[15]),32);
        bufp->chgIData(oldp+66,(vlSelf->ysyx_25040109_top__DOT__mem__DOT__unnamedblk1__DOT__len),32);
    }
    bufp->chgBit(oldp+67,(vlSelf->clk));
    bufp->chgBit(oldp+68,(vlSelf->rst));
    bufp->chgIData(oldp+69,(vlSelf->pc),32);
    bufp->chgIData(oldp+70,(vlSelf->inst),32);
    bufp->chgIData(oldp+71,(vlSelf->p_count_number),32);
    bufp->chgIData(oldp+72,(vlSelf->a0_out),32);
}
