...
VL_INLINE_OPT void Vysyx_25040109_top___024root___nba_sequent__TOP__0(Vysyx_25040109_top___024root* vlSelf) {
    ...
    __Vdly__ysyx_25040109_top__DOT__cpu__DOT__idu_exu_pc = 0;
    IData/*31:0*/ __Vdly__ysyx_25040109_top__DOT__cpu__DOT__u_exu__DOT__alu_result;
    __Vdly__ysyx_25040109_top__DOT__cpu__DOT__u_exu__DOT__alu_result = 0;
    ...
    // Body
    vlSelf->__Vdly__ysyx_25040109_top__DOT__ifu_data 
    ...
    __Vdly__ysyx_25040109_top__DOT__cpu__DOT__idu_exu_pc 
    ...
    __Vdly__ysyx_25040109_top__DOT__cpu__DOT__u_exu__DOT__alu_result 
    ...
    if (vlSelf->rst) {
        ...
        __Vdly__ysyx_25040109_top__DOT__cpu__DOT__idu_exu_pc = 0U;
    } else {
    ...
    if (vlSelf->rst) {
        ...
        vlSelf->ysyx_25040109_top__DOT__cpu__DOT__exu_lsu_rd_addr = 0U;
...
VL_INLINE_OPT void Vysyx_25040109_top___024root___nba_sequent__TOP__2(Vysyx_25040109_top___024root* vlSelf) {
    ...
    // Body
    vlSelf->pc = vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu_idu_pc;
    if (vlSelf->rst) {
    ...
    if (vlSelf->rst) {
        vlSelf->__Vdly__ysyx_25040109_top__DOT__ifu_data = 0U;
        vlSelf->ysyx_25040109_top__DOT__ifu_ready = 1U;
    } else if (VL_UNLIKELY(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu_idu_valid)) {
        ...
        VL_WRITEF("rdata:0x%08x\n\n",32,vlSelf->ysyx_25040109_top__DOT__ifu_data);
        vlSelf->ysyx_25040109_top__DOT__ifu_ready = 1U;
    } else {
        vlSelf->ysyx_25040109_top__DOT__ifu_ready = 1U;
    }
    vlSelf->ysyx_25040109_top__DOT__cpu__DOT__idu_ifu_ready 
        = (1U & ((IData)(vlSelf->rst) | (~ ((IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu_idu_valid) 
                                            & (IData)(vlSelf->ysyx_25040109_top__DOT__cpu__DOT__exu_idu_ready)))));
    vlSelf->ysyx_25040109_top__DOT__ifu_data = vlSelf->__Vdly__ysyx_25040109_top__DOT__ifu_data;
    vlSelf->ysyx_25040109_top__DOT__cpu__DOT__u_ifu__DOT__pc 
        = vlSelf->__Vdly__ysyx_25040109_top__DOT__cpu__DOT__u_ifu__DOT__pc;
    vlSelf->ysyx_25040109_top__DOT__cpu__DOT__ifu_idu_valid 
        = vlSelf->__Vdly__ysyx_25040109_top__DOT__cpu__DOT__ifu_idu_valid;
